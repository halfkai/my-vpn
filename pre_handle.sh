...
if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    sed -i -e "s/<${credential_prefix}reality_domain>/$reality_domain/g" "$PWD/nginx/nginx.conf"
    ...
    sed -i -e "s/<${credential_prefix}reality_domain>/$reality_domain/g" "$PWD/nginx/conf.d/free.conf"
